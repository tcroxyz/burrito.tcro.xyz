...
export default function SinglePost() {
  ...
  return (
    <motion.main
      ...
      className="bg-purple-100 min-h-screen p-4 pt-6 lg:p-16"
    >
      <article className="container shadow-lg mx-auto bg-purple-200 rounded-lg border-2 border-gray-100">
        <header className="relative">
          <div className="absolute h-full w-full flex items-center justify-center p-8">
            <div className="bg-purple-300 bg-opacity-75 rounded p-12 mt-12 shadow-lg border-2 border-gray-100">
        ...
        <div className="px-4 lg:px-20 py-40 lg:py-40 prose lg:prose-xl max-w-full rounded-md ">
          <BlockConent
